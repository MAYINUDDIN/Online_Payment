...
const Banner = () => {
    return (
        <div className='grid lg:grid-cols-1 gap-4'>
            ...
            <div class="lg:card lg:card-side bg-base-100 shadow ">
                ...
                <div class=" card-body w-60 m-0 lg:card-body w-48 m-3">
                    ...
                    <div class="justify-left mt-5">
                        <button class="bg-gradient-to-r from-cyan-500 to-blue-500 btn btn-success font-bold hover:to-success-500 rounded w-38 text-white outline-zinc-600font-bold">PAYMENT NOW</button>
                    </div>
                </div>
                <div class=" flex flex-col lg:flex-row">
                    <div class="text-primary divider lg:divider-horizontal "></div>
                </div>
                <div class="card-body w-60 m-0 lg:card-body w-36 ">
                    ...
                    <div class="justify-left ">
                        <button class="lg:bg-gradient-to-r  from-cyan-500 to-blue-500 btn btn-success  hover:to-success-500 rounded w-32 text-white  font-bold">LEARN MORE</button>
                    </div>
                </div>
            </div>
